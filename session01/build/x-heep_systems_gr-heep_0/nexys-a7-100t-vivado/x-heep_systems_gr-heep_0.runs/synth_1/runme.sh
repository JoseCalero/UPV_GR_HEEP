...
HD_PWD='/home/mfpdsmbaa/LabCatreda/GR-HEEP/build/x-heep_systems_gr-heep_0/nexys-a7-100t-vivado/x-heep_systems_gr-heep_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log xilinx_gr_heep_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source xilinx_gr_heep_wrapper.tcl
