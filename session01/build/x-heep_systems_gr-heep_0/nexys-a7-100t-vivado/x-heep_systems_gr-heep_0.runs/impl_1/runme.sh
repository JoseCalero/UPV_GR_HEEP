...
HD_PWD='/home/mfpdsmbaa/LabCatreda/GR-HEEP/build/x-heep_systems_gr-heep_0/nexys-a7-100t-vivado/x-heep_systems_gr-heep_0.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log xilinx_gr_heep_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source xilinx_gr_heep_wrapper.tcl -notrace
