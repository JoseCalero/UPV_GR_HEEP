...
VL_ATTR_COLD void Vtestharness_gpio__Tz2_TBz3___stl_sequent__TOP__testharness__DOT__gr_heep_i__DOT__core_v_mini_mcu_i__DOT__ao_peripheral_subsystem_i__DOT__gpio_ao_i__0(Vtestharness_gpio__Tz2_TBz3* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtestharness_gpio__Tz2_TBz3___stl_sequent__TOP__testharness__DOT__gr_heep_i__DOT__core_v_mini_mcu_i__DOT__ao_peripheral_subsystem_i__DOT__gpio_ao_i__0\n"); );
