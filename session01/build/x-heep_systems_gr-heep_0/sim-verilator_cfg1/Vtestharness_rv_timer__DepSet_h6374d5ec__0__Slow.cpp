...
VL_ATTR_COLD void Vtestharness_rv_timer___stl_sequent__TOP__testharness__DOT__gr_heep_i__DOT__core_v_mini_mcu_i__DOT__ao_peripheral_subsystem_i__DOT__rv_timer_0_1_i__0(Vtestharness_rv_timer* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtestharness_rv_timer___stl_sequent__TOP__testharness__DOT__gr_heep_i__DOT__core_v_mini_mcu_i__DOT__ao_peripheral_subsystem_i__DOT__rv_timer_0_1_i__0\n"); );
...
VL_ATTR_COLD void Vtestharness_rv_timer___stl_sequent__TOP__testharness__DOT__gr_heep_i__DOT__core_v_mini_mcu_i__DOT__peripheral_subsystem_i__DOT__rv_timer_2_3_i__0(Vtestharness_rv_timer* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtestharness_rv_timer___stl_sequent__TOP__testharness__DOT__gr_heep_i__DOT__core_v_mini_mcu_i__DOT__peripheral_subsystem_i__DOT__rv_timer_2_3_i__0\n"); );
    Vtestharness__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
    CData/*0:0*/ u_reg__DOT____VdfgRegularize_h1012a72b_0_21;
